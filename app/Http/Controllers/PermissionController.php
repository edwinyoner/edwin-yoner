...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backend.permissions.index')->with('success', 'Permiso creado exitosamente.');
    }
    ...
    public function update(Request $request, Permission $permission)
    {
        ...
        return redirect()->route('backend.permissions.index')->with('success', 'Permiso actualizado exitosamente.');
    }

    public function destroy(Permission $permission)
    {
        $permission->delete();
        return redirect()->route('backend.permissions.index')->with('success', 'Permiso eliminado exitosamente.');
    }
}