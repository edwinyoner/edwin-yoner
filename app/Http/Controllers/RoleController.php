...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
        try {
            ...
            return Response::json(['success' => true, 'message' => 'Rol creado exitosamente.', 'redirect' => route('backend.roles.index')]);
        } catch (\Exception $e) {
    ...
    public function update(RoleRequest $request, Role $role)
    {
        try {
            ...
            return Response::json(['success' => true, 'message' => 'Rol actualizado exitosamente.', 'redirect' => route('backend.roles.index')]);
        } catch (\Exception $e) {
    ...
    {
        $role->delete();
        return redirect()->route('backend.roles.index')->with('success', 'Rol eliminado exitosamente.');
    }
}