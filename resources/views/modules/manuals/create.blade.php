...
@section('subtitle', 'Subir Manual')
@section('content_header_title', 'Manual del Usuario')
@section('content_header_subtitle', 'Subir nuevo manual')

@section('content_body')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <x-adminlte-card title="Subir Nuevo Manual" theme="primary" icon="fas fa-upload">
                <form action="{{ route('user_manuals.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="col-md-12">
                            <x-adminlte-input name="title" label="Título del Manual"
                                placeholder="Ej: Manual de Usuario v2.0" value="{{ old('title') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <x-adminlte-textarea name="description" label="Descripción"
                                ...
                                rows="3">{{ old('description') }}</x-adminlte-textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="file">Archivo del Manual</label>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('backend.user_manuals.index') }}" class="btn btn-secondary">
                                    <i class="fas fa-arrow-left mr-2"></i>Cancelar
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-upload mr-2"></i>Subir Manual
                                </button>
                            </div>
                        </div>
                    </div>
