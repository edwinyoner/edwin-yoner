...
@section('content_header_subtitle', 'Editar categoría de tecnologías')
...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-7">
            <x-adminlte-card title="Editar Categoría de Tecnologías"
                             theme="warning" icon="fas fa-folder">

                <form method="POST"
                      action="{{ route('backend.technology-categories.update', $technologyCategory->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <x-adminlte-input name="name_en"
                                      label="Nombre (EN)"
                                      placeholder="Ej: Backend"
                                      value="{{ old('name_en', $technologyCategory->name_en) }}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-warning">
                    ...
                    <small class="form-text text-muted mb-3">
                        ⚠️ Cambiar el slug puede afectar referencias existentes.
                    </small>
                    ...
                    <x-adminlte-input name="icon_class"
                                      ...
                                      value="{{ old('icon_class', $technologyCategory->icon_class) }}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-warning">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   id="color"
                                   placeholder="#3B82F6"
                                   value="{{ old('color', $technologyCategory->color) }}"
                                   maxlength="7">
                            <div class="input-group-append">
                                <input type="color"
                                       id="colorPicker"
                                       class="form-control"
                                       value="{{ old('color', $technologyCategory->color) ?? '#3B82F6' }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description"
                                  ...
                                  rows="3"
                                  maxlength="500"
                                  placeholder="Descripción breve de la categoría...">{{ old('description', $technologyCategory->description) }}</textarea>
                        <small class="form-text text-muted d-flex justify-content-between">
                            <span>Máx. 500 caracteres.</span>
                            <span id="desc-count">
                                {{ strlen(old('description', $technologyCategory->description ?? '')) }} / 500
                            </span>
                        </small>
                        @error('description')
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox"
                                   ...
                                   name="is_active"
                                   value="1"
                                   {{ old('is_active', $technologyCategory->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="alert alert-light border text-center mt-3">
                        ...
                        <i id="iconPreview"
                           class="{{ $technologyCategory->icon_with_fallback }} fa-3x"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    iconInput?.addEventListener('input', function () {
        iconPreview.className =
            (this.value.trim() || 'fas fa-folder') + ' fa-3x';
    });
