...
@section('subtitle', 'Editar Proyecto')
@section('content_header_title', 'Proyectos')
@section('content_header_subtitle', 'Editar proyecto del portafolio')
...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <x-adminlte-card title="Editar Proyecto" theme="warning" icon="fas fa-project-diagram">

                <form method="POST"
                      action="{{ route('backend.projects.update', $project->id) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <small class="form-text text-muted mb-3">
                                ⚠️ Cambiar el slug puede romper enlaces existentes al proyecto.
                            </small>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description"
                                          ...
                                          rows="3"
                                          maxlength="500"
                                          placeholder="Descripción breve del proyecto...">{{ old('short_description', $project->short_description) }}</textarea>
                                <small class="form-text text-muted d-flex justify-content-between">
                                    <span>Máx. 500 caracteres.</span>
                                    <span id="short-desc-count">
                                        {{ strlen(old('short_description', $project->short_description ?? '')) }} / 500
                                    </span>
                                </small>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="long_description"
                                          ...
                                          rows="6"
                                          maxlength="10000"
                                          placeholder="Descripción detallada del proyecto...">{{ old('long_description', $project->long_description) }}</textarea>
                                <small class="form-text text-muted d-flex justify-content-between">
                                    <span>Máx. 10,000 caracteres.</span>
                                    <span id="long-desc-count">
                                        {{ strlen(old('long_description', $project->long_description ?? '')) }} / 10000
                                    </span>
                                </small>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="thumbnail_image">
                                        {{ $project->thumbnail_image ? 'Cambiar imagen' : 'Seleccionar imagen' }}
                                    </label>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                                                ...
                                                @foreach($techs as $tech)
                                                    <div class="custom-control custom-checkbox mb-1">
                                                        <input type="checkbox"
                                                               ...
                                                               name="technologies[]"
                                                               value="{{ $tech->id }}"
                                                               {{ in_array($tech->id, old('technologies', $selectedTechnologies)) ? 'checked' : '' }}>
                            ...
                            <small class="text-muted">
                                <span id="tech-count">{{ count($selectedTechnologies) }}</span>
                                tecnología(s) seleccionada(s)
                            </small>
                        @endif
                    </div>
                        ...
                        <div>
                            <a href="{{ route('backend.projects.show', $project->id) }}"
                               class="btn btn-info btn-sm mr-2">
                                <i class="fas fa-eye mr-1"></i> Ver Galería
                            </a>
...
document.addEventListener('DOMContentLoaded', function () {
        ...
        if (this.files && this.files[0]) {
            ...
            reader.onload = e => {
                ...
                if (preview.tagName === 'IMG') {
                    ...
                    preview.outerHTML = `<img id="thumbnail-preview"
                        src="${e.target.result}"
    ...
    document.querySelectorAll('.tech-checkbox')
            .forEach(cb => cb.addEventListener('change', updateTechCount));
