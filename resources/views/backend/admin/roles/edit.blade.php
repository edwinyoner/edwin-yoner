            ...
            <div class="col-md-6">
                <x-adminlte-card title="Acceso Denegado" theme="danger" icon="fas fa-exclamation-triangle">
                    <div class="text-center">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('backend.roles.index') }}" class="btn btn-primary">
                    ...
                    <x-adminlte-card title="Acción Restringida" theme="warning" icon="fas fa-shield-alt">
                        <div class="text-center">
                            ...
                            <div class="mt-3">
                                ...
                                @endcan
                                <a href="{{ route('backend.roles.show', $role->id) }}" class="btn btn-info">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <x-adminlte-card title="Editar Permisos del Rol" theme="primary" icon="fas fa-edit" collapsible>
                        <form method="POST" action="{{ route('backend.roles.update', $role->id) }}" id="roleEditForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <div>
                                    @can('ver roles')
                                        <a href="{{ route('backend.roles.index') }}" class="btn btn-secondary btn-sm">
                                            <i class="fas fa-arrow-left mr-1"></i> Volver a Roles
                                        </a>
                                    @else
                                    ...
                                    @endcan
                                    <a href="{{ route('backend.roles.show', $role->id) }}" class="btn btn-info btn-sm ml-2">
