            ...
            <div class="row justify-content-center equal-height-cards">
                <div class="col-md-6">
                    <x-adminlte-card title="Editar Usuario" theme="warning" icon="fas fa-user-edit" collapsible>
                        <form method="POST" action="{{ route('backend.users.update', $user) }}" id="userForm">
                            @csrf
                            @method('PUT')
                            ...
                            {{-- Nombre --}}
                            <x-adminlte-input name="name" label="Nombre del Usuario" placeholder="Ej. Juan Chavez"
                            ...
                            {{-- Correo --}}
                            <x-adminlte-input name="email" label="Correo Electrónico" placeholder="Ej. juanchavez@eiccosac.com"
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                {{-- Botón Volver --}}
                                @can('ver usuarios')
                                    <a href="{{ route('backend.users.index') }}" class="btn btn-secondary btn-sm">
